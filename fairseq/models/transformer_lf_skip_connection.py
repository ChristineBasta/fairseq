...
@register_model("transformer_lf_skip_connection")
class TransformerLFSkipConnectionModel(FairseqEncoderDecoderModel):
    """
...
class TransformerEncoder(FairseqEncoder):
    ...
    def build_encoder_layer_skip_connection(self, args):
        layer = TransformerEncoderLayerSkipConnection(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_tiny")
...
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection")
...
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_iwslt_de_en")
def transformer_iwslt_de_en(args):
    ...
    args.two_skip = getattr(args, "two_skip", False)
    args.before_skip = getattr(args, "before_skip", True)
    args.mid_skip = getattr(args, "mid_skip", False)
    base_architecture(args)


@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_wmt_en_de")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_vaswani_wmt_en_de_big")
...
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_wmt_en_de_big")
...
@register_model_architecture("transformer_lf_skip_connection", "transformer_lf_skip_connection_wmt_en_de_big_t2t")
